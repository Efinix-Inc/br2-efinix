...
{
	int i;
	for (i = 0; i < sizeof(mode_common_regs)/sizeof(mode_common_regs[0]); i++) {
...
void PiCamV3_ConfigFormat(u8 mode)
{
	...
	int i;
	if (mode == 0) {
		for (i = 0; i < sizeof(mode_1920x1080_cropped_regs)/sizeof(mode_1920x1080_cropped_regs[0]); i++) {
			PiCamV3_WriteRegData(mode_1920x1080_cropped_regs[i].address,mode_1920x1080_cropped_regs[i].val);
		}
	}

	else if (mode == 1) {
		for (i = 0; i < sizeof(mode_2x2binned_1920x1080_regs)/sizeof(mode_2x2binned_1920x1080_regs[0]); i++) {
			PiCamV3_WriteRegData(mode_2x2binned_1920x1080_regs[i].address,mode_2x2binned_1920x1080_regs[i].val);
		}
	}

	else if (mode == 2) {
		for (i = 0; i < sizeof(mode_hdr_1920x1080_regs)/sizeof(mode_hdr_1920x1080_regs[0]); i++) {
...
{
	int i;
	for (i = 0; i < sizeof(link_450Mhz_regs)/sizeof(link_450Mhz_regs[0]); i++) {
