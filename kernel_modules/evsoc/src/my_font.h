...
#ifndef __FONT_8X8__
#define __FONT_8X8__
static const unsigned char console_font_8x8[] = {
...
static bool is_ch_show(unsigned char pCh, int pos_y, int pos_x, int pScan)
{
    static unsigned int lAllLen = 0;
    unsigned int lBase = 0;
    if (lAllLen == 0)
    {
        lAllLen = sizeof(console_font_8x8);
    }
    ...
    return ((console_font_8x8[lBase] & (0x80 >> pos_x)) == 0) ? false : true;
}
#endif
