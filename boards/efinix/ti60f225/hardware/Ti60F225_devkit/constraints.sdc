# PLL Constraints
#################
create_clock -period 4.0 io_systemClk
create_clock -period 20.0 io_peripheralClk
...
set_false_path -setup -hold soc_inst/memoryReset
set_false_path -setup -hold soc_inst/peripheralReset
