...
//gcc -o raystones raystones.c -lm -O2  -fno-stack-protector -w -Wl,--no-relax -ffast-math
...
{
  return csr_read(0xC02);
}

/*
uint64_t ccc = 0;
uint64_t rdcycle(){ ccc += 1000; return ccc;}
uint64_t rdinstret(){ ccc += 1000; return ccc;}
*/
