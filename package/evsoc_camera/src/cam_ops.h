...
#define IMX708_I2C_ADDRESS				((uint16_t)0x1A)
#define DW9807_I2C_ADDRESS				((uint16_t)0x0C)
#define IMX708_REG_EXPOSURE				((uint16_t)0x0202)
#define IMX708_REG_DIGITAL_GAIN				((uint16_t)0x020e)
